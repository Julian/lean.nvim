...
describe('infoview', function()
  describe('lean 4', function()
    ...
    function(_)
      ...
      assert.has_all(infoview.get_current_infoview().info.pin.div:render(), {"expected type", "⊢ Nat"})
    end)
    ...
    function(_)
      ...
      infoview.get_current_infoview().info.pin:update(true)
      assert.pin_pos_changed.pin_text_changed.infoview()
      assert.has_all(infoview.get_current_infoview().info.pin.div:render(),
  ...
  describe('lean 3', function()
    ...
    function(_)
      ...
      infoview.get_current_infoview().info.pin:update(true)
      assert.pin_pos_changed.pin_text_changed.infoview()
      assert.has_all(infoview.get_current_infoview().info.pin.div:render(), {"⊢ ℕ"})
    end)
    ...
    function(_)
      ...
      infoview.get_current_infoview().info.pin:update(true)
      assert.pin_pos_changed.pin_text_changed.infoview()
      assert.has_all(infoview.get_current_infoview().info.pin.div:render(), {"p q : Prop", "h : p ∨ q", "⊢ q ∨ p"})
    end)
    ...
    function(_)
      ...
      infoview.get_current_infoview().info.pin:update(true)
      assert.pin_pos_changed.pin_text_changed.infoview()
      assert.equal(infoview.get_current_infoview().info.pin.div:render(),
      '▶ expected type:\n⊢ Type 1')
    end)
  end)
