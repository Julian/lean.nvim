...
describe('infoview', function()
  describe('lean 4', function()
    ...
    function(_)
      ...
      assert.has_all(infoview.get_current_infoview().info.msg, {"expected type", "⊢ Nat"})
    end)
  ...
  describe('lean 3', function()
    ...
    function(_)
      ...
      infoview.__update()
      assert.info_text_changed.infoview()
      assert.has_all(infoview.get_current_infoview().info.msg, {"⊢ ℕ"})
    end)
    ...
    function(_)
      ...
      infoview.__update()
      assert.info_text_changed.infoview()
      assert.has_all(infoview.get_current_infoview().info.msg, {"p q : Prop", "h : p ∨ q", "⊢ q ∨ p"})
    end)
    ...
    function(_)
      ...
      infoview.__update()
      assert.info_text_changed.infoview()
      assert.equal(table.concat(infoview.get_current_infoview().info.msg, "\n"), '▶ 1 goal\n\n⊢ Type 1')
    end)
  end)
